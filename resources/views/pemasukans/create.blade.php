...
<input type="number" min=0 name="uang_masuk" class="form-control" placeholder="Uang Masuk">
</div>
</div>
<div class="col-xs-12 col-sm-12 col-md-12">
<div class="form-group">
<strong>Total Uang:</strong>
<input type="number" name="total_uang" class="form-control" placeholder="Total Uang">
</div>
</div>
<div class="col-xs-12 col-sm-12 col-md-12">
<div class="form-group">
